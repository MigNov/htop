...
void CRT_setColors(int colorScheme) {
   ...
   if (colorScheme == COLORSCHEME_MONOCHROME) {
      ...
      CRT_colors[SENSORS] = ColorPair(Yellow,White);
      ...
      CRT_colors[SENSORS] = ColorPair(Yellow,Black);
      ...
      CRT_colors[SENSORS] = A_BOLD | ColorPair(Yellow,Blue);
      ...
      CRT_colors[SENSORS] = ColorPair(Green,Black);
      ...
      CRT_colors[SENSORS] = A_BOLD | ColorPair(Cyan,Black);
